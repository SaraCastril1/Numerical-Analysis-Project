function submitForm(event) {
    ...
    fetch("http://localhost:5000/procesar", {
        ...
        .then(data => {
            ...
            document.getElementById("newton_raphson_method_results").innerHTML = "";
            document.getElementById("newton_raphson_method_results").appendChild(table);
        })
